...
/**
 * @Author: rua
 * @Date: 2021/7/22 13:58
 * @Description:
 */
public class SolutionP547 {
	...
	private class UnionFind6 implements UF {
		...
		private int find(int p) {
			...
			// 如果p不是根节点 就让p指向p的父节点(下一节点)的父节点
			// 通过find(parent[p])得到  不能写find(p)会无限迭代
			//当最后相等了 说明是根节点了 就停止了迭代
			return parent[p];
		}
		//这样find 1次:会使当前节点(p)-->到其根节点之间的所有节点都指向根节点
	...
	public int findCircleNum(int[][] isConnected) {
			...
			return unionFind6.findRootSize();
